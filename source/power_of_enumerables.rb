...
def print_odd_indexed_integers(sorted_slicesay)
  sorted_slicesay.each_with_index do |number, index|
...
def odd_integers(sorted_slicesay)
  sorted_slicesay.select {|number| number.odd?}
end
